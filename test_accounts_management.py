...
class TestAccountsManagement(unittest.TestCase):
    ...
    def test_create_account(self):
        account = Account(str(uuid.uuid4()), "John", "Doe", datetime(1990, 1, 1), "john@example.com", "password123", 1, True)
        result = self.accounts_management.create_account(account)
        self.assertTrue(result)

    def test_create_account_duplicate_email(self):
        account1 = Account(str(uuid.uuid4()), "John", "Doe", datetime(1990, 1, 1), "john@example.com", "password123", 1, True)
        account2 = Account(str(uuid.uuid4()), "John", "Smith", datetime(1990, 1, 1), "john@example.com", "password123", 1, True)
    ...
    def test_update_account(self):
        account = Account(str(uuid.uuid4()), "John", "Doe", datetime(1990, 1, 1), "john@example.com", "password123", 1, True)
        self.accounts_management.create_account(account)
        updated_account = Account(str(uuid.uuid4()), "John", "Smith", datetime(1990, 1, 1), "john@example.com", "password123", 1, True)
    ...
    def test_invalid_email(self):
        account = Account(str(uuid.uuid4()), "John", "Doe", datetime(1990, 1, 1), "invalid_email", "password123", 1, True)
        result = self.accounts_management.create_account(account)
        self.assertFalse(result)

    def test_birth_date_before_current_date(self):
        account = Account(str(uuid.uuid4()), "John", "Doe", datetime(2099, 1, 1), "john@example.com", "password123", 1, True)
        result = self.accounts_management.create_account(account)
        self.assertFalse(result)
